        ...
        <div class="container logo-navegacion">
            ...
            <nav class="navigation">
                <ul>
                    ...
                    <li><a href="finalprono.php">Pronosticar Final</a></li>
...
<caption>FASE DE SEMIFINAL</caption>
...
<thead>
  ...
  while ($line = mysqli_fetch_array($result)) {
    ...
    if($puesto_clasificatoria == 'semifinal'){/**PARA IDENTIFICAR INGRESAR "OCTAVOS" */
                    ...
                    if($numero_partido5 == $numero_partido4){
                      ...
                      while ($line6 = mysqli_fetch_array($result6)) {
                          ...
                          if($nombre_estadio == $nombre_estadio2){
                            ...
                            echo "\t\t<td>
                            <form class='col-12' action='pronosticador.php' method='get'>
