...
$ver1="admin";/*esto es el CGI*/
$ver2="admin";/*esto es el CGI*/
...
while($line = mysqli_fetch_array($result)){ 
    ...
    if($usuario == $ver1){
        if($contrasena == $ver2){
            ...
            echo"<a class=btn btn-primary href=Menu_admin.php role=button>INGRESAR</a>";
            echo "<br>"; /**esto es el CGI */
            $verificacion = false;
            break;
        }else{
...
if($verificacion == true){
    ...
    echo "<br>"; /**esto es el CGI */
    echo"<a class=btn btn-primary href=Inicio_admin.html role=button>REINTENTAR</a>";
    echo "<br>"; /**esto es el CGI */
}
